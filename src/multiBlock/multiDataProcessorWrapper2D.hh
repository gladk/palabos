...
template<typename T>
void applyProcessingFunctional (
        NTensorFieldBoxProcessingFunctional2D<T>* functional,
        Box2D domain,
...
template<typename T>
void applyProcessingFunctional (
        MaskedNTensorFieldBoxProcessingFunctional2D<T>* functional,
        Box2D domain,
        std::vector<MultiNTensorField2D<T>*> fields,
...
void integrateProcessingFunctional (
        ...
        Box2D domain, MultiBlockLattice2D<T,Descriptor>& lattice, plint level )
{
...
template<typename T, template<typename U> class Descriptor>
void applyProcessingFunctional(MaskedBoxProcessingFunctional2D_L<T,Descriptor>* functional,
                               Box2D domain,
...
template<typename T, template<typename U> class Descriptor>
void integrateProcessingFunctional (
        MaskedBoxProcessingFunctional2D_L<T,Descriptor>* functional,
        Box2D domain,
        MultiBlockLattice2D<T,Descriptor>& lattice,
        MultiNTensorField2D<int>& mask,
        plint level )
...
void applyProcessingFunctional(BoxProcessingFunctional2D_S<T>* functional,
                               Box2D domain, MultiScalarField2D<T>& field)
{
...
void integrateProcessingFunctional(BoxProcessingFunctional2D_S<T>* functional,
                                   Box2D domain, MultiScalarField2D<T>& field, plint level)
{
...
void applyProcessingFunctional(BoxProcessingFunctional2D_T<T,nDim>* functional,
                               Box2D domain, MultiTensorField2D<T,nDim>& field)
{
    executeDataProcessor( BoxProcessorGenerator2D(functional, domain), field );
}
...
template<typename T>
void applyProcessingFunctional(BoxProcessingFunctional2D_N<T>* functional,
...
template<typename T>
void integrateProcessingFunctional(BoxProcessingFunctional2D_N<T>* functional,
                                   Box2D domain, MultiNTensorField2D<T>& field,
                                   plint level)
{
    addInternalProcessor( BoxProcessorGenerator2D(functional, domain), field, level );
...
template<typename T>
void applyProcessingFunctional(MaskedBoxProcessingFunctional2D_N<T>* functional,
                               Box2D domain,
...
template<typename T>
void integrateProcessingFunctional(MaskedBoxProcessingFunctional2D_N<T>* functional,
                                   Box2D domain,
                                   MultiNTensorField2D<T>& field,
                                   MultiNTensorField2D<int>& mask,
                                   plint level)
...
template<typename T1, typename T2>
void integrateProcessingFunctional(BoxProcessingFunctional2D_SS<T1,T2>* functional,
                                   Box2D domain,
                                   MultiScalarField2D<T1>& field1,
...
void integrateProcessingFunctional (
        ...
        Box2D domain,
        MultiTensorField2D<T1,nDim1>& field1,
        MultiTensorField2D<T2,nDim2>& field2, plint level)
{
    addInternalProcessor( BoxProcessorGenerator2D(functional, domain),
                          field1, field2, level );
}
...
template<typename T1, typename T2>
void applyProcessingFunctional (
        BoxProcessingFunctional2D_NN<T1,T2>* functional,
        Box2D domain,
...
template<typename T1, typename T2>
void applyProcessingFunctional (
        MaskedBoxProcessingFunctional2D_NN<T1,T2>* functional,
        Box2D domain,
        MultiNTensorField2D<T1>& field1,
        MultiNTensorField2D<T2>& field2,
        MultiNTensorField2D<int>& mask )
...
void applyProcessingFunctional(BoxProcessingFunctional2D_ST<T1,T2,nDim>* functional,
                               Box2D domain,
                               MultiScalarField2D<T1>& field1,
...
template<typename T1, typename T2, int nDim>
void integrateProcessingFunctional(BoxProcessingFunctional2D_ST<T1,T2,nDim>* functional,
                                   Box2D domain,
                                   MultiScalarField2D<T1>& field1,
                                   MultiTensorField2D<T2,nDim>& field2, plint level)
{
    addInternalProcessor( BoxProcessorGenerator2D(functional, domain),
                          field1, field2, level );
}
...
template<typename T1, typename T2>
void applyProcessingFunctional(BoxProcessingFunctional2D_SN<T1,T2>* functional,
                               Box2D domain,
                               MultiScalarField2D<T1>& field1,
                               MultiNTensorField2D<T2>& field2 )
{
...
template<typename T1, typename T2>
void integrateProcessingFunctional(BoxProcessingFunctional2D_SN<T1,T2>* functional,
                                   Box2D domain,
                                   MultiScalarField2D<T1>& field1,
                                   MultiNTensorField2D<T2>& field2, plint level)
{
...
void integrateProcessingFunctional (
        ...
        Box2D domain,
        MultiBlockLattice2D<T1,Descriptor>& lattice,
        MultiScalarField2D<T2>& field, plint level )
{
    addInternalProcessor( BoxProcessorGenerator2D(functional, domain),
                          lattice, field, level );
}
...
void integrateProcessingFunctional (
        ...
        Box2D domain,
        MultiBlockLattice2D<T1,Descriptor>& lattice,
        MultiTensorField2D<T2,nDim>& field, plint level )
{
    addInternalProcessor( BoxProcessorGenerator2D(functional, domain),
                          lattice, field, level );
}
...
template<typename T1, template<typename U> class Descriptor, typename T2>
void applyProcessingFunctional (
        BoxProcessingFunctional2D_LN<T1,Descriptor,T2>* functional,
        Box2D domain,
        MultiBlockLattice2D<T1,Descriptor>& lattice,
...
void integrateProcessingFunctional (
        ...
        Box2D domain,
        MultiBlockLattice2D<T1,Descriptor>& lattice,
        MultiNTensorField2D<T2>& field, plint level )
{
    addInternalProcessor( BoxProcessorGenerator2D(functional, domain),
                          lattice, field, level );
}
...
template<typename T1, template<typename U> class Descriptor, typename T2>
void applyProcessingFunctional (
        MaskedBoxProcessingFunctional2D_LN<T1,Descriptor,T2>* functional,
        Box2D domain,
        MultiBlockLattice2D<T1,Descriptor>& lattice,
        MultiNTensorField2D<T2>& field,
        MultiNTensorField2D<int>& mask )
...
template<typename T>
void applyProcessingFunctional (
        NTensorFieldDotProcessingFunctional2D<T>* functional,
        DotList2D const& dotList,
        std::vector<MultiNTensorField2D<T>*> fields )
{
    std::vector<MultiBlock2D*> multiBlocks(fields.size());
...
void applyProcessingFunctional(DotProcessingFunctional2D_S<T>* functional,
                               DotList2D const& dotList, MultiScalarField2D<T>& field)
{
...
template<typename T>
void applyProcessingFunctional(DotProcessingFunctional2D_N<T>* functional,
                               DotList2D const& dotList,
                               MultiNTensorField2D<T>& field)
{
    executeDataProcessor( DotProcessorGenerator2D(functional, dotList), field );
...
template<typename T>
void integrateProcessingFunctional(DotProcessingFunctional2D_N<T>* functional,
                                   DotList2D const& dotList,
...
template<typename T1, typename T2>
void applyProcessingFunctional (
        DotProcessingFunctional2D_SS<T1,T2>* functional,
        DotList2D const& dotList,
        MultiScalarField2D<T1>& field1,
        MultiScalarField2D<T2>& field2 )
{
...
template<typename T1, typename T2>
void integrateProcessingFunctional(DotProcessingFunctional2D_SS<T1,T2>* functional,
                                   DotList2D const& dotList,
                                   MultiScalarField2D<T1>& field1,
                                   MultiScalarField2D<T2>& field2, plint level)
{
...
template<typename T1, typename T2>
void applyProcessingFunctional (
        DotProcessingFunctional2D_NN<T1,T2>* functional,
        DotList2D const& dotList,
        MultiNTensorField2D<T1>& field1,
        MultiNTensorField2D<T2>& field2 )
{
...
template<typename T1, typename T2, int nDim>
void applyProcessingFunctional(DotProcessingFunctional2D_ST<T1,T2,nDim>* functional,
                               DotList2D const& dotList,
                               MultiScalarField2D<T1>& field1,
                               MultiTensorField2D<T2,nDim>& field2 )
{
...
template<typename T1, typename T2, int nDim>
void integrateProcessingFunctional(DotProcessingFunctional2D_ST<T1,T2,nDim>* functional,
                                   DotList2D const& dotList,
                                   MultiScalarField2D<T1>& field1,
                                   MultiTensorField2D<T2,nDim>& field2, plint level)
{
...
template<typename T1, typename T2>
void applyProcessingFunctional(DotProcessingFunctional2D_SN<T1,T2>* functional,
                               DotList2D const& dotList,
                               MultiScalarField2D<T1>& field1,
                               MultiNTensorField2D<T2>& field2 )
{
...
template<typename T1, typename T2>
void integrateProcessingFunctional(DotProcessingFunctional2D_SN<T1,T2>* functional,
                                   DotList2D const& dotList,
                                   MultiScalarField2D<T1>& field1,
                                   MultiNTensorField2D<T2>& field2, plint level)
{
...
template<typename T1, template<typename U> class Descriptor, typename T2>
void applyProcessingFunctional (
        DotProcessingFunctional2D_LN<T1,Descriptor,T2>* functional,
        DotList2D const& dotList,
        MultiBlockLattice2D<T1,Descriptor>& lattice,
        MultiNTensorField2D<T2>& field )
{
        ...
        plint boundaryWidth, plint level )
{
    ...
    integrateProcessingFunctional(functional, domain, multiBlocks,
                                  boundaryWidth, level);
}
        ...
        plint boundaryWidth, plint level )
{
    ...
    integrateProcessingFunctional(functional, domain,
                                  multiBlocks, boundaryWidth, level);
}
...
template<typename T>
void applyProcessingFunctional (
        BoundedNTensorFieldBoxProcessingFunctional2D<T>* functional,
        Box2D domain,
...
void applyProcessingFunctional (
        ...
        Box2D domain, MultiBlockLattice2D<T,Descriptor>& lattice, plint boundaryWidth )
{
...
template<typename T>
void applyProcessingFunctional (
        BoundedBoxProcessingFunctional2D_S<T>* functional,
        Box2D domain, MultiScalarField2D<T>& field, plint boundaryWidth )
{
    std::vector<MultiBlock2D*> multiBlocks(1);
...
void applyProcessingFunctional (
        ...
        Box2D domain, MultiTensorField2D<T,nDim>& field, plint boundaryWidth )
{
    std::vector<MultiBlock2D*> multiBlocks(1);
    multiBlocks[0] = dynamic_cast<MultiBlock2D*>(&field);
    applyProcessingFunctional(functional, domain, multiBlocks, boundaryWidth);
...
template<typename T>
void applyProcessingFunctional (
        BoundedBoxProcessingFunctional2D_N<T>* functional,
        Box2D domain, MultiNTensorField2D<T>& field, plint boundaryWidth )
{
    std::vector<MultiBlock2D*> multiBlocks(1);
    multiBlocks[0] = dynamic_cast<MultiBlock2D*>(&field);
    applyProcessingFunctional(functional, domain, multiBlocks, boundaryWidth);
...
template<typename T>
void applyProcessingFunctional (
        BoundedMaskedBoxProcessingFunctional2D_N<T>* functional,
        Box2D domain,
        MultiNTensorField2D<T>& field,
        MultiNTensorField2D<int>& mask,
        plint boundaryWidth )
...
template<typename T1, typename T2>
void applyProcessingFunctional (
        BoundedBoxProcessingFunctional2D_NN<T1,T2>* functional,
        Box2D domain,
        MultiNTensorField2D<T1>& field1,
        MultiNTensorField2D<T2>& field2,
        plint boundaryWidth )
...
template<typename T1, typename T2>
void applyProcessingFunctional (
        BoundedMaskedBoxProcessingFunctional2D_NN<T1,T2>* functional,
        Box2D domain,
        MultiNTensorField2D<T1>& field1,
        MultiNTensorField2D<T2>& field2,
        MultiNTensorField2D<int>& mask,
...
template<typename T1, typename T2>
void applyProcessingFunctional (
        BoundedBoxProcessingFunctional2D_SN<T1,T2>* functional,
        Box2D domain,
        MultiScalarField2D<T1>& field1,
        MultiNTensorField2D<T2>& field2,
        plint boundaryWidth )
...
template<typename T1, template<typename U> class Descriptor, typename T2>
void applyProcessingFunctional (
        BoundedBoxProcessingFunctional2D_LN<T1,Descriptor,T2>* functional,
        Box2D domain,
        MultiBlockLattice2D<T1,Descriptor>& lattice,
        MultiNTensorField2D<T2>& field,
        plint boundaryWidth )
...
template<typename T1, template<typename U> class Descriptor, typename T2>
void applyProcessingFunctional (
        BoundedMaskedBoxProcessingFunctional2D_LN<T1,Descriptor,T2>* functional,
        Box2D domain,
        MultiBlockLattice2D<T1,Descriptor>& lattice,
        MultiNTensorField2D<T2>& field,
        MultiNTensorField2D<int>& mask,
