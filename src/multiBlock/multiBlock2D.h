...
template <typename T> class TypedAtomicBlock2D;
template <typename T> class EulerianAtomicBlock2D;
...
public:
    ...
    public:
        ProcessorStorage2D(DataProcessorGenerator2D const& generator_,
...
public:
    ...
    void storeProcessor(DataProcessorGenerator2D const& generator,
...
public:
    ...
    virtual void copyReceive (
                ...
                Box2D const& toDomain, modif::ModifT whichData=modif::dataStructure ) =0;
