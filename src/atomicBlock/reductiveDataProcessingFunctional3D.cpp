...
ReductiveBoxProcessor3D::ReductiveBoxProcessor3D (
        ReductiveBoxProcessingFunctional3D* functional_,
...
ReductiveBoxProcessorGenerator3D::ReductiveBoxProcessorGenerator3D (
        ReductiveBoxProcessingFunctional3D* functional_,
        Box3D domain )
    : BoxedReductiveDataProcessorGenerator3D(domain),
...
ReductiveBoxProcessorGenerator3D::ReductiveBoxProcessorGenerator3D(ReductiveBoxProcessorGenerator3D const& rhs)
    : BoxedReductiveDataProcessorGenerator3D(rhs),
...
void ReductiveBoxProcessorGenerator3D::getModificationPattern (
...
ReductiveDotProcessor3D::ReductiveDotProcessor3D(ReductiveDotProcessingFunctional3D* functional_,
...
ReductiveDotProcessorGenerator3D::ReductiveDotProcessorGenerator3D (
        ReductiveDotProcessingFunctional3D* functional_,
        DotList3D const& dotList )
    : DottedReductiveDataProcessorGenerator3D(dotList),
      functional(functional_)
{ }
...
ReductiveDotProcessorGenerator3D::ReductiveDotProcessorGenerator3D (
    ...
    : DottedReductiveDataProcessorGenerator3D(rhs),
      functional(rhs.functional->clone())
{ }
...
void ReductiveDotProcessorGenerator3D::getModificationPattern (
        std::vector<bool>& isWritten ) const
{
    functional->getModificationPattern(isWritten);
}
...
void BoundedReductiveBoxProcessingFunctional3D::getModificationPattern(std::vector<bool>& isWritten) const {
    std::vector<modif::ModifT> modified(isWritten.size());
    getTypeOfModification(modified);
    PLB_ASSERT(modified.size()==isWritten.size());
    for (pluint iBlock=0; iBlock<isWritten.size(); ++iBlock) {
...
ReductiveBoxProcessingFunctional3D* BoundedReductiveBoxProcessingFunctional3D::getBulkProcessor() const {
...
BlockDomain::DomainT BoundedReductiveBoxProcessingFunctional3D::BulkWrapperFunctional::appliesTo() const
{
...
BlockStatistics&
    BoundedReductiveBoxProcessingFunctional3D::BulkWrapperFunctional::getStatistics()
{
    return boundedFunctional -> getStatistics();
}
...
BlockDomain::DomainT BoundedReductiveBoxProcessingFunctional3D::PlaneWrapperFunctional::appliesTo() const
{
    return boundedFunctional->appliesTo();
}
...
BlockStatistics&
    BoundedReductiveBoxProcessingFunctional3D::PlaneWrapperFunctional::getStatistics()
{
    return boundedFunctional -> getStatistics();
}
...
BlockDomain::DomainT BoundedReductiveBoxProcessingFunctional3D::EdgeWrapperFunctional::appliesTo() const
{
    return boundedFunctional->appliesTo();
}
...
BlockStatistics&
    BoundedReductiveBoxProcessingFunctional3D::EdgeWrapperFunctional::getStatistics()
{
    return boundedFunctional -> getStatistics();
}
...
BlockDomain::DomainT BoundedReductiveBoxProcessingFunctional3D::CornerWrapperFunctional::appliesTo() const
{
    return boundedFunctional->appliesTo();
}
...
BlockStatistics&
    BoundedReductiveBoxProcessingFunctional3D::CornerWrapperFunctional::getStatistics()
{
    return boundedFunctional -> getStatistics();
}
        ...
        std::vector<ReductiveBoxProcessorGenerator3D*>& generators )
{
    ...
    generators[1] = new ReductiveBoxProcessorGenerator3D(getPlaneProcessor(0,-1), surf.surface0N());
    generators[2] = new ReductiveBoxProcessorGenerator3D(getPlaneProcessor(0,+1), surf.surface0P());
    generators[3] = new ReductiveBoxProcessorGenerator3D(getPlaneProcessor(1,-1), surf.surface1N());
    generators[4] = new ReductiveBoxProcessorGenerator3D(getPlaneProcessor(1,+1), surf.surface1P());
    generators[5] = new ReductiveBoxProcessorGenerator3D(getPlaneProcessor(2,-1), surf.surface2N());
    generators[6] = new ReductiveBoxProcessorGenerator3D(getPlaneProcessor(2,+1), surf.surface2P());

    generators[7] = new ReductiveBoxProcessorGenerator3D(getEdgeProcessor(0, -1, -1), surf.edge0NN() );
    generators[8] = new ReductiveBoxProcessorGenerator3D(getEdgeProcessor(0, -1,  1), surf.edge0NP() );
    generators[9] = new ReductiveBoxProcessorGenerator3D(getEdgeProcessor(0,  1, -1), surf.edge0PN() );
    generators[10] = new ReductiveBoxProcessorGenerator3D(getEdgeProcessor(0,  1,  1), surf.edge0PP() );
    generators[11] = new ReductiveBoxProcessorGenerator3D(getEdgeProcessor(1, -1, -1), surf.edge1NN() );
    generators[12] = new ReductiveBoxProcessorGenerator3D(getEdgeProcessor(1, -1,  1), surf.edge1NP() );
    generators[13] = new ReductiveBoxProcessorGenerator3D(getEdgeProcessor(1,  1, -1), surf.edge1PN() );
    generators[14] = new ReductiveBoxProcessorGenerator3D(getEdgeProcessor(1,  1,  1), surf.edge1PP() );
    generators[15] = new ReductiveBoxProcessorGenerator3D(getEdgeProcessor(2, -1, -1), surf.edge2NN() );
    generators[16] = new ReductiveBoxProcessorGenerator3D(getEdgeProcessor(2, -1,  1), surf.edge2NP() );
    generators[17] = new ReductiveBoxProcessorGenerator3D(getEdgeProcessor(2,  1, -1), surf.edge2PN() );
    generators[18] = new ReductiveBoxProcessorGenerator3D(getEdgeProcessor(2,  1,  1), surf.edge2PP() );

    generators[19] = new ReductiveBoxProcessorGenerator3D(getCornerProcessor(-1, -1, -1), surf.cornerNNN() );
    generators[20] = new ReductiveBoxProcessorGenerator3D(getCornerProcessor(-1, -1,  1), surf.cornerNNP() );
    generators[21] = new ReductiveBoxProcessorGenerator3D(getCornerProcessor(-1,  1, -1), surf.cornerNPN() );
    generators[22] = new ReductiveBoxProcessorGenerator3D(getCornerProcessor(-1,  1,  1), surf.cornerNPP() );
    generators[23] = new ReductiveBoxProcessorGenerator3D(getCornerProcessor( 1, -1, -1), surf.cornerPNN() );
    generators[24] = new ReductiveBoxProcessorGenerator3D(getCornerProcessor( 1, -1,  1), surf.cornerPNP() );
    generators[25] = new ReductiveBoxProcessorGenerator3D(getCornerProcessor( 1,  1, -1), surf.cornerPPN() );
    generators[26] = new ReductiveBoxProcessorGenerator3D(getCornerProcessor( 1,  1,  1), surf.cornerPPP() );
