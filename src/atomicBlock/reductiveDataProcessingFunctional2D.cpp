...
ReductiveBoxProcessorGenerator2D::ReductiveBoxProcessorGenerator2D(ReductiveBoxProcessorGenerator2D const& rhs)
    : BoxedReductiveDataProcessorGenerator2D(rhs),
...
void ReductiveBoxProcessorGenerator2D::getModificationPattern (
...
ReductiveDotProcessor2D::ReductiveDotProcessor2D(ReductiveDotProcessingFunctional2D* functional_,
...
ReductiveDotProcessorGenerator2D::ReductiveDotProcessorGenerator2D (
        ReductiveDotProcessingFunctional2D* functional_,
        DotList2D const& dotList )
    : DottedReductiveDataProcessorGenerator2D(dotList),
      functional(functional_)
{ }
...
ReductiveDotProcessorGenerator2D::ReductiveDotProcessorGenerator2D (
    ...
    : DottedReductiveDataProcessorGenerator2D(rhs),
      functional(rhs.functional->clone())
{ }
...
void ReductiveDotProcessorGenerator2D::getModificationPattern (
        std::vector<bool>& isWritten ) const
{
    functional->getModificationPattern(isWritten);
}
...
ReductiveBoxProcessingFunctional2D* BoundedReductiveBoxProcessingFunctional2D::getBulkProcessor() const {
...
BlockDomain::DomainT BoundedReductiveBoxProcessingFunctional2D::BulkWrapperFunctional::appliesTo() const
{
...
void BoundedReductiveBoxProcessingFunctional2D::BulkWrapperFunctional::
...
BlockStatistics&
    BoundedReductiveBoxProcessingFunctional2D::BulkWrapperFunctional::getStatistics()
{
    return boundedFunctional -> getStatistics();
}
...
BlockDomain::DomainT BoundedReductiveBoxProcessingFunctional2D::EdgeWrapperFunctional::appliesTo() const
{
    return boundedFunctional->appliesTo();
}
...
void BoundedReductiveBoxProcessingFunctional2D::EdgeWrapperFunctional::
         getModificationPattern(std::vector<bool>& isWritten) const
{
    boundedFunctional->getModificationPattern(isWritten);
}
...
BlockStatistics&
    BoundedReductiveBoxProcessingFunctional2D::EdgeWrapperFunctional::getStatistics()
{
    return boundedFunctional -> getStatistics();
}
...
BlockDomain::DomainT BoundedReductiveBoxProcessingFunctional2D::CornerWrapperFunctional::appliesTo() const
{
    return boundedFunctional->appliesTo();
}
...
void BoundedReductiveBoxProcessingFunctional2D::CornerWrapperFunctional::
         getModificationPattern(std::vector<bool>& isWritten) const
{
    boundedFunctional->getModificationPattern(isWritten);
}
...
BlockStatistics&
    BoundedReductiveBoxProcessingFunctional2D::CornerWrapperFunctional::getStatistics()
{
    return boundedFunctional -> getStatistics();
}
