...
BoxProcessorGenerator2D::BoxProcessorGenerator2D(BoxProcessingFunctional2D* functional_, Box2D domain)
    : BoxedDataProcessorGenerator2D(domain),
...
BoxProcessorGenerator2D::BoxProcessorGenerator2D(BoxProcessorGenerator2D const& rhs)
    : BoxedDataProcessorGenerator2D(rhs),
      functional(rhs.functional->clone())
{ }
...
DotProcessorGenerator2D::DotProcessorGenerator2D(DotProcessingFunctional2D* functional_, DotList2D const& dotList)
    : DottedDataProcessorGenerator2D(dotList),
      functional(functional_)
{ }
...
DotProcessorGenerator2D::DotProcessorGenerator2D(DotProcessorGenerator2D const& rhs)
    : DottedDataProcessorGenerator2D(rhs),
      functional(rhs.functional->clone())
{ }
...
BoundedBoxProcessingFunctional2D::BoundedBoxProcessingFunctional2D()
    : dxScale(0),
      dtScale(0)
{ }
