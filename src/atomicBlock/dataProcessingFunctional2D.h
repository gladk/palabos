...
public:
    BoxProcessor2D(BoxProcessingFunctional2D* functional_,
...
public:
    DotProcessor2D(DotProcessingFunctional2D* functional_,
...
public:
    DotProcessorGenerator2D(DotProcessingFunctional2D* functional_,
...
public:
    ...
    public:
        EdgeWrapperFunctional(BoundedBoxProcessingFunctional2D* boundedFunctional_,
    ...
    public:
        CornerWrapperFunctional(BoundedBoxProcessingFunctional2D* boundedFunctional_,
...
struct BoundedMaskedBoxProcessingFunctional2D_N : public BoundedBoxProcessingFunctional2D {
    ...
    virtual void processBulk(Box2D domain, NTensorField2D<T>& lattice, NTensorField2D<int>& mask) =0;
    virtual void processEdge( int direction, int orientation, Box2D domain,
                              NTensorField2D<T>& lattice, NTensorField2D<int>& mask ) =0;
    virtual void processCorner( int normalX, int normalY, Box2D domain,
                                NTensorField2D<T>& lattice, NTensorField2D<int>& mask ) =0;
};
...
struct BoundedLatticeBoxProcessingFunctional2D
    : public BoundedBoxProcessingFunctional2D
{
    virtual void processBulkGeneric( Box2D domain,
                                     std::vector<AtomicBlock2D*> atomicBlocks );
    virtual void processEdgeGeneric( int direction, int orientation, Box2D domain,
