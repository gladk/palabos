...
void integrateProcessingFunctional (
        ...
        Box2D domain, BlockLattice2D<T,Descriptor>& lattice, plint level )
{
...
void integrateProcessingFunctional(BoxProcessingFunctional2D_S<T>* functional,
                                   Box2D domain, ScalarField2D<T>& field, plint level)
{
...
void integrateProcessingFunctional (
        ...
        Box2D domain,
        TensorField2D<T1,nDim1>& field1,
        TensorField2D<T2,nDim2>& field2, plint level)
{
    addInternalProcessor( BoxProcessorGenerator2D(functional, domain),
                          field1, field2, level );
}
...
void integrateProcessingFunctional (
        ...
        Box2D domain,
        BlockLattice2D<T1,Descriptor>& lattice,
        ScalarField2D<T2>& field, plint level )
{
    addInternalProcessor( BoxProcessorGenerator2D(functional, domain),
                          lattice, field, level );
}
...
void applyProcessingFunctional(DotProcessingFunctional2D_S<T>* functional,
                               DotList2D const& dotList, ScalarField2D<T>& field)
{
...
void integrateProcessingFunctional(DotProcessingFunctional2D_N<T>* functional,
                                   DotList2D const& dotList,
                                   NTensorField2D<T>& field, plint level)
{
    addInternalProcessor( DotProcessorGenerator2D(functional, dotList), field, level );
}
...
void applyProcessingFunctional (
        ...
        Box2D domain, ScalarField2D<T>& field, plint boundaryWidth )
{
    std::vector<AtomicBlock2D*> atomicBlocks(1);
...
void applyProcessingFunctional (
        ...
        Box2D domain, TensorField2D<T,nDim>& field, plint boundaryWidth )
{
    std::vector<AtomicBlock2D*> atomicBlocks(1);
    atomicBlocks[0] = dynamic_cast<AtomicBlock2D*>(&field);
    applyProcessingFunctional(functional, domain, atomicBlocks, boundaryWidth);
...
void applyProcessingFunctional (
        ...
        Box2D domain, NTensorField2D<T>& field, plint boundaryWidth )
{
    std::vector<AtomicBlock2D*> atomicBlocks(1);
    atomicBlocks[0] = dynamic_cast<AtomicBlock2D*>(&field);
    applyProcessingFunctional(functional, domain, atomicBlocks, boundaryWidth);
