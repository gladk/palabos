...
public:
    ...
    template<int direction, int orientation> static BoxProcessingFunctional3D_L<T,Descriptor>*
    ...
    template<int plane, int normal1, int normal2> static BoxProcessingFunctional3D_L<T,Descriptor>*
    ...
    template<int xNormal, int yNormal, int zNormal> static BoxProcessingFunctional3D_L<T,Descriptor>*
...
template<typename T, template<typename U> class Descriptor>
template<int direction, int orientation>
BoundaryCompositeDynamics<T,Descriptor>* WrappedZouHeBoundaryManager3D<T,Descriptor>::
    getVelocityBoundaryDynamics(Dynamics<T,Descriptor>* baseDynamics)
{
...
template<int direction, int orientation>
BoxProcessingFunctional3D_L<T,Descriptor>*
    WrappedZouHeBoundaryManager3D<T,Descriptor>::
        getVelocityBoundaryFunctional()
{
...
{
    bool automaticPrepareCollision = false;
    return new RegularizedVelocityInnerEdgeDynamics3D
                   <T,Descriptor,plane,normal1,normal2>(baseDynamics,automaticPrepareCollision);
}
