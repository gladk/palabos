...
void PlaneFdBoundaryFunctional3D<T,Descriptor,direction,orientation>::
...
template<typename T, template<typename U> class Descriptor, int plane, int normal1, int normal2>
T OuterVelocityEdgeFunctional3D<T,Descriptor, plane,normal1,normal2>::
...
void OuterVelocityEdgeFunctional3D<T,Descriptor, plane,normal1,normal2>::
        ...
        plint iX, plint iY, plint iZ, BlockLattice3D<T,Descriptor>& lattice )
{
    ...
    Array<T,Descriptor<T>::d> dx_u, dy_u, dz_u;
    fd::DirectedGradients3D<T, Descriptor, 0, xNormal, 0, true>::o1_velocityDerivative(dx_u, lattice, iX,iY,iZ);
    fd::DirectedGradients3D<T, Descriptor, 1, yNormal, 0, true>::o1_velocityDerivative(dy_u, lattice, iX,iY,iZ);
    fd::DirectedGradients3D<T, Descriptor, 2, zNormal, 0, true>::o1_velocityDerivative(dz_u, lattice, iX,iY,iZ);
