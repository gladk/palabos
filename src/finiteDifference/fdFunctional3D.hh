    ...
    for (plint iX=domain.x0; iX<=domain.x1; ++iX) {
        for (plint iY=domain.y0; iY<=domain.y1; ++iY) {
            for (plint iZ=domain.z0; iZ<=domain.z1; ++iZ) {
                derivative.get(iX+offset.x, iY+offset.y, iZ+offset.z) = fdDataField::bulkXderiv(value, iX, iY, iZ );
            }
        }
    }
}
...
template<typename T>
void BoxXderivativeFunctional3D<T>::processEdge( int plane, int normal1, int normal2, Box3D domain,
                                                 ScalarField3D<T>& value, ScalarField3D<T>& derivative)
{
    Dot3D offset = computeRelativeDisplacement(value, derivative);
    for (plint iX=domain.x0; iX<=domain.x1; ++iX) {
...
template<typename T>
void BoxXderivativeFunctional3D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
        ...
        Box3D domain, ScalarField3D<T>& value, ScalarField3D<T>& derivative )
{
    ...
    for (plint iX=domain.x0; iX<=domain.x1; ++iX) {
        for (plint iY=domain.y0; iY<=domain.y1; ++iY) {
            for (plint iZ=domain.z0; iZ<=domain.z1; ++iZ) {
                derivative.get(iX+offset.x, iY+offset.y, iZ+offset.z) = fdDataField::bulkYderiv(value, iX, iY, iZ );
            }
        }
    }
}
...
template<typename T>
void BoxYderivativeFunctional3D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T>
void BoxZderivativeFunctional3D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T>
void BoxGradientNormFunctional3D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T>
void BoxPeriodicGradientFunctional3D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T>
BoxPoissonIteration3D<T>::BoxPoissonIteration3D(T beta_)
    : beta(beta_)
{ }
        ...
        for (plint iY=domain.y0; iY<=domain.y1; ++iY) {
            for (plint iZ=domain.z0; iZ<=domain.z1; ++iZ) {
                ...
                new_u_h.get(iX+offset1.x,iY+offset1.y,iZ+offset1.z) =
                    ...
                    (beta/(T)6) * (sumPressure + rhs.get(iX+offset2.x,iY+offset2.y,iZ+offset2.z) );
            }
        }
    }
}
...
template<typename T>
void BoxXperiodicDerivativeFunctional3D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T>
void BoxYperiodicDerivativeFunctional3D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T>
void BoxZperiodicDerivativeFunctional3D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T>
void BoxPeriodicGradientNormFunctional3D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T>
BoxPeriodicPoissonIteration3D<T>::BoxPeriodicPoissonIteration3D(T beta_)
    : beta(beta_)
{ }
...
template<typename T>
void BoxPeriodicPoissonIteration3D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
    modified[2] = modif::nothing;
}
