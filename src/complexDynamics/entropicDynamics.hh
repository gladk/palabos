...
int EntropicDynamics<T,Descriptor>::id =
    meta::registerOneParamDynamics<T,Descriptor,EntropicDynamics<T,Descriptor> >("Entropic");
...
int ForcedEntropicDynamics<T,Descriptor>::id =
    meta::registerOneParamDynamics<T,Descriptor,ForcedEntropicDynamics<T,Descriptor> >("Entropic_Forced");
