...
InamuroAdvectionDiffusionIteration3D<T,ScalarFunction>::InamuroAdvectionDiffusionIteration3D(ScalarFunction scalarFunction_, T tau_)
    : scalarFunction(scalarFunction_),
      tau(tau_)
{ }
...
template<typename T, class ScalarFunction>
InamuroAdvectionDiffusionIteration3D<T,ScalarFunction>* InamuroAdvectionDiffusionIteration3D<T,ScalarFunction>::clone() const {
    return new InamuroAdvectionDiffusionIteration3D<T,ScalarFunction>(*this);
}

template<typename T, class ScalarFunction>
void InamuroAdvectionDiffusionIteration3D<T,ScalarFunction>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
...
template<typename T, class ScalarFunction>
IndexedInamuroAdvectionDiffusionIteration3D<T,ScalarFunction>::IndexedInamuroAdvectionDiffusionIteration3D(
...
template<typename T, class ScalarFunction>
void IndexedInamuroAdvectionDiffusionIteration3D<T,ScalarFunction>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::staticVariables;  // RhoBar
    modified[1] = modif::nothing;          // Container Block with triangle data.
}

template<typename T, class ScalarFunction>
BlockDomain::DomainT IndexedInamuroAdvectionDiffusionIteration3D<T,ScalarFunction>::appliesTo() const {
    return BlockDomain::bulk;
}
...
template<typename T>
ConstScalarInamuroAdvectionDiffusionIteration3D<T>::ConstScalarInamuroAdvectionDiffusionIteration3D(T wallScalar_, T tau_)
    : wallScalar(wallScalar_),
      tau(tau_)
{ }
...
template<typename T>
ConstScalarInamuroAdvectionDiffusionIteration3D<T>* ConstScalarInamuroAdvectionDiffusionIteration3D<T>::clone() const {
    return new ConstScalarInamuroAdvectionDiffusionIteration3D<T>(*this);
}

template<typename T>
void ConstScalarInamuroAdvectionDiffusionIteration3D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::staticVariables;  // RhoBar
    modified[1] = modif::nothing;          // Container Block with triangle data.
}
...
template<typename T>
InstantiateImmersedAdvectionDiffusionWallData3D<T>* InstantiateImmersedAdvectionDiffusionWallData3D<T>::clone() const {
    return new InstantiateImmersedAdvectionDiffusionWallData3D<T>(*this);
}

template<typename T>
void InstantiateImmersedAdvectionDiffusionWallData3D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
...
template<typename T>
InstantiateImmersedAdvectionDiffusionWallDataWithTagging3D<T>::InstantiateImmersedAdvectionDiffusionWallDataWithTagging3D (
            std::vector< Array<T,3> > const& vertices_,
            std::vector<T> const& areas_, int solutionDomainFlag_ )
    : vertices(vertices_),
      areas(areas_),
      solutionDomainFlag(solutionDomainFlag_)
{
    PLB_ASSERT(vertices.size() == areas.size());
}
...
template<typename T>
void InstantiateImmersedAdvectionDiffusionWallDataWithTagging3D<T>::getTypeOfModification(std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::staticVariables;  // Container Block with triangle data.
    modified[1] = modif::nothing;  // Flag matrix.
}

template<typename T>
BlockDomain::DomainT InstantiateImmersedAdvectionDiffusionWallDataWithTagging3D<T>::appliesTo() const {
    return BlockDomain::bulk;
}
...
template<typename T>
BlockDomain::DomainT InstantiateImmersedAdvectionDiffusionWallDataWithIndexedTagging3D<T>::appliesTo() const {
    return BlockDomain::bulk;
}
        ...
        Box3D domain, std::vector<AtomicBlock3D*> fields )
{
    ...
    BlockLattice3D<T,AD_Descriptor> *ad_lattice = dynamic_cast<BlockLattice3D<T,AD_Descriptor>*>(fields[0]);
    PLB_ASSERT(ad_lattice);
    BlockLattice3D<T,Descriptor> *lattice = dynamic_cast<BlockLattice3D<T,Descriptor>*>(fields[1]);
    PLB_ASSERT(lattice);
