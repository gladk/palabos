...
template<typename T, template<typename U> class Descriptor>
void createInterfaces(std::vector<MultiBlockLattice2D<T,Descriptor>*>& multiBlocks,
...
void createCoarseGridInterface (
        plint coarseLevel, Box2D coarseGridInterface, std::vector<MultiBlockLattice2D<T,Descriptor>*>& multiBlocks,
        plint orientation );

/// Instantiate the necessary data processors for the fine grid interface
template<typename T, template<typename U> class Descriptor>
void createFineGridInterface (
        plint coarseLevel, Box2D fineGridInterface, std::vector<MultiBlockLattice2D<T,Descriptor>*>& multiBlocks,
        plint orientation );


/// Use the MultiGridManagement2D to generate a vector of scalar fields with the same distribution as
///  the multi grid
template<typename T>
...
/// Use the MultiGridManagement2D to generate a vector of tensor fields with the same distribution as
///  the multi grid
...
class LinearInterpolationFineGridInterfaceInstantiator 
    ...
    public:
        ...
        virtual plint getEnvelopeWidth(){return 1;}
};
...
class CubicInterpolationFineGridInterfaceInstantiator 
    ...
    public:
        ...
        virtual plint getEnvelopeWidth(){return 2;}
};
...
class MultiGridGenerator2D {
    public:
        static std::auto_ptr< MultiGridLattice2D<T,Descriptor> > createRefinedLatticeCubicInterpolationNoFiltering(
                        MultiGridManagement2D management,
                        Dynamics<T,Descriptor>* backgroundDynamics, plint behaviorLevel );
                        
        static std::auto_ptr< MultiGridLattice2D<T,Descriptor> > createRefinedLatticeLinearInterpolationNoFiltering(
                        MultiGridManagement2D management,
                        Dynamics<T,Descriptor>* backgroundDynamics, plint behaviorLevel );
                        
        static std::auto_ptr< MultiGridLattice2D<T,Descriptor> > createRefinedLatticeCubicInterpolationFiltering(
                        MultiGridManagement2D management,
                        Dynamics<T,Descriptor>* backgroundDynamics, plint behaviorLevel );
                        
        static std::auto_ptr< MultiGridLattice2D<T,Descriptor> > createRefinedLatticeLinearInterpolationFiltering(
                        MultiGridManagement2D management,
                        Dynamics<T,Descriptor>* backgroundDynamics, plint behaviorLevel);
