...
template<typename T, template<typename U> class Descriptor>
std::auto_ptr<MultiGridLattice2D<T,Descriptor> > extractSubDomain(
        MultiGridLattice2D<T,Descriptor>& lattice, Box2D domain )
{
    MultiGridLattice2D<T,Descriptor>* extractedLattice = new MultiGridLattice2D<T,Descriptor>(lattice, domain);
    extractSubDomain(lattice, *extractedLattice, domain);
    return std::auto_ptr<MultiGridLattice2D<T,Descriptor> >(extractedLattice);
}
...
{
    applyProcessingFunctional (
            new BoxDensityFunctional2D<T,Descriptor>, domain, lattice, density,lattice.getReferenceLevel() );
}
...
std::auto_ptr<MultiGridScalarField2D<T> > computeDensity(MultiGridLattice2D<T,Descriptor>& lattice, Box2D domain)
{
    ...
    return std::auto_ptr<MultiGridScalarField2D<T> >(density);
}
...
{
    applyProcessingFunctional (
            new BoxRhoBarFunctional2D<T,Descriptor>, domain, lattice, rhoBar, lattice.getReferenceLevel() );
}
...
std::auto_ptr<MultiGridScalarField2D<T> > computeRhoBar(MultiGridLattice2D<T,Descriptor>& lattice, Box2D domain)
{
    ...
    return std::auto_ptr<MultiGridScalarField2D<T> >(rhoBar);
}
...
{
    applyProcessingFunctional (
            new BoxKineticEnergyFunctional2D<T,Descriptor>, domain, lattice, energy, lattice.getReferenceLevel() );
}
...
std::auto_ptr<MultiGridScalarField2D<T> > computeKineticEnergy(MultiGridLattice2D<T,Descriptor>& lattice, Box2D domain)
{
    ...
    return std::auto_ptr<MultiGridScalarField2D<T> >(energy);
}   
...
void computeVelocityNorm(
        MultiGridLattice2D<T,Descriptor>& lattice, MultiGridScalarField2D<T>& velocityNorm, Box2D domain )
{
    applyProcessingFunctional (
...
std::auto_ptr<MultiGridScalarField2D<T> > computeVelocityNorm(MultiGridLattice2D<T,Descriptor>& lattice, Box2D domain)
{
    ...
    return std::auto_ptr<MultiGridScalarField2D<T> >(velocityNorm);
}
                                                               ...
                                                               Box2D domain, plint iComponent)
{
    ...
    return std::auto_ptr<MultiGridScalarField2D<T> >(velocityComponent);
}

template<typename T, template<typename U> class Descriptor>
std::auto_ptr<MultiGridScalarField2D<T> > computeVelocityComponent(
...
{
    applyProcessingFunctional (
            new BoxVelocityFunctional2D<T,Descriptor>, domain, lattice, velocity, lattice.getReferenceLevel() );
}
...
Box2D domain)
{
    ...
    return std::auto_ptr<MultiGridTensorField2D<T,Descriptor<T>::d> >(velocity);
}
...
{
    applyProcessingFunctional (
            new BoxPiNeqFunctional2D<T,Descriptor>, domain, lattice, PiNeq, lattice.getReferenceLevel() );
}
    ...
    computePiNeq(MultiGridLattice2D<T,Descriptor>& lattice, Box2D domain)
{
    ...
    return std::auto_ptr<MultiGridTensorField2D<T,SymmetricTensor<T,Descriptor>::n> >(PiNeq);
}
...
{
    applyProcessingFunctional (
            new BoxShearStressFunctional2D<T,Descriptor>, domain, lattice, stress, lattice.getReferenceLevel() );
}
    ...
    computeShearStress(MultiGridLattice2D<T,Descriptor>& lattice, Box2D domain)
{
    ...
    return std::auto_ptr<MultiGridTensorField2D<T,SymmetricTensor<T,Descriptor>::n> >(stress);
}
...
{
    applyProcessingFunctional (
            new BoxStrainRateFromStressFunctional2D<T,Descriptor>, domain, lattice, S, lattice.getReferenceLevel() );
}
    ...
    computeStrainRateFromStress(MultiGridLattice2D<T,Descriptor>& lattice, Box2D domain)
{
    ...
    return std::auto_ptr<MultiGridTensorField2D<T,SymmetricTensor<T,Descriptor>::n> >(S);
}
...
{
    applyProcessingFunctional (
    new BoxTemperatureFunctional2D<T,Descriptor>, domain, lattice, temperature, lattice.getReferenceLevel() );
}
...
std::auto_ptr<MultiGridScalarField2D<T> > computeTemperature(MultiGridLattice2D<T,Descriptor>& lattice, Box2D domain)
{
    ...
    return std::auto_ptr<MultiGridScalarField2D<T> >(temperature);
}
...
{
    applyProcessingFunctional (
        new BoxSoundSpeedFunctional2D<T,Descriptor>, domain, lattice, soundSpeed, lattice.getReferenceLevel() );
}
...
std::auto_ptr<MultiGridScalarField2D<T> > computeSoundSpeed(MultiGridLattice2D<T,Descriptor>& lattice, Box2D domain)
{
    ...
    return std::auto_ptr<MultiGridScalarField2D<T> >(soundSpeed);
}
...
{
    applyProcessingFunctional (
        new BoxPopulationFunctional2D<T,Descriptor>(iPop), domain, lattice, population,lattice.getReferenceLevel());
}
                                                        ...
                                                        Box2D domain, plint iPop)
{
    ...
    return std::auto_ptr<MultiGridScalarField2D<T> >(population);
}
...
{
    applyProcessingFunctional (
       new BoxAllPopulationsFunctional2D<T,Descriptor>(), domain, lattice, populations,lattice.getReferenceLevel());
}

template<typename T, template<typename U> class Descriptor>
std::auto_ptr<MultiGridScalarField2D<T> > computeAllPopulations(MultiGridLattice2D<T,Descriptor>& lattice,
                                                            Box2D domain)
{
    MultiGridTensorField2D<T,Descriptor<T>::q>* populations = 
            new MultiGridTensorField2D<T,Descriptor<T>::q>(lattice, domain);
    computeAllPopulations(lattice, *populations, domain);
    return std::auto_ptr<MultiGridTensorField2D<T,Descriptor<T>::q> >(populations);
}
...
template<typename T, template<typename U> class Descriptor>
void copyPopulations(MultiGridLattice2D<T,Descriptor>& latticeFrom, MultiGridLattice2D<T,Descriptor>& latticeTo,
                     Box2D domain)
{
    applyProcessingFunctional (
...
{
    applyProcessingFunctional (
            new ExtractScalarSubDomainFunctional2D<T>, domain, field, extractedField, field.getReferenceLevel() );
}
...
std::auto_ptr<MultiGridScalarField2D<T> > extractSubDomain(MultiGridScalarField2D<T>& field, Box2D domain)
{
    ...
    return std::auto_ptr<MultiGridScalarField2D<T> >(extractedField);
}
...
{
    applyProcessingFunctional (
            new A_minus_alpha_functional2D<T>(scalar), domain, field, result, field.getReferenceLevel() );
}
...
{
    applyProcessingFunctional (
            new Alpha_minus_A_functional2D<T>(scalar), domain, field, result, field.getReferenceLevel() );
}
...
{
    applyProcessingFunctional (
            new A_times_alpha_functional2D<T>(scalar), domain, field, result, field.getReferenceLevel() );
}
...
{
    applyProcessingFunctional (
            new A_dividedBy_alpha_functional2D<T>(scalar), domain, field, result, field.getReferenceLevel() );
}
...
{
    applyProcessingFunctional (
            new Alpha_dividedBy_A_functional2D<T>(scalar), domain, field, result, field.getReferenceLevel() );
}
...
void subtractInPlace(MultiGridScalarField2D<T>& field, T scalar, Box2D domain) {
    applyProcessingFunctional (
            new A_minus_alpha_inplace_functional2D<T>(scalar), domain, field, field.getReferenceLevel());
}
...
void multiplyInPlace(MultiGridScalarField2D<T>& field, T scalar, Box2D domain) {
    applyProcessingFunctional (
            new A_times_alpha_inplace_functional2D<T>(scalar), domain, field, field.getReferenceLevel());
}
...
void divideInPlace(MultiGridScalarField2D<T>& field, T scalar, Box2D domain) {
    applyProcessingFunctional (
            new A_dividedBy_alpha_inplace_functional2D<T>(scalar), domain, field, field.getReferenceLevel());
}
...
{
    applyProcessingFunctional (
            new CopyConvertScalarFunctional2D<T1,T2>, domain, field, convertedField, field.getReferenceLevel() );
}
...
std::auto_ptr<MultiGridScalarField2D<T2> > copyConvert(MultiGridScalarField2D<T1>& field, Box2D domain)
{
    ...
    return std::auto_ptr<MultiGridScalarField2D<T2> >(convertedField);
}
...
void add(MultiGridScalarField2D<T>& A, MultiGridScalarField2D<T>& B, MultiGridScalarField2D<T>& result, Box2D domain)
{
    ...
    applyProcessingFunctional (
            new A_plus_B_functional2D<T>, domain, fields, A.getReferenceLevel() );
}
...
domain)
{
    ...
    fields.push_back(&result);
    applyProcessingFunctional (
            new A_minus_B_functional2D<T>, domain, fields, A.getReferenceLevel() );
}
...
domain)
{
    ...
    fields.push_back(&result);
    applyProcessingFunctional (
            new A_times_B_functional2D<T>, domain, fields, A.getReferenceLevel() );
}
...
{
    MultiGridTensorField2D<T,nDim>* extractedField = new MultiGridTensorField2D<T,nDim>(field, domain);
    extractSubDomain(field, *extractedField, domain);
    return std::auto_ptr<MultiGridTensorField2D<T,nDim> >(extractedField);
}
...
{
    applyProcessingFunctional (
            new ExtractTensorComponentFunctional2D<T,nDim>(iComponent),
...
int iComponent)
{
    ...
    return std::auto_ptr<MultiGridScalarField2D<T> >(component);
}
...
template<typename T, int nDim>
void computeNorm(MultiGridTensorField2D<T,nDim>& tensorField, MultiGridScalarField2D<T>& component, Box2D domain)
{
    applyProcessingFunctional (
            new ComputeNormFunctional2D<T,nDim>, domain, component, tensorField, tensorField.getReferenceLevel() );
}
...
template<typename T, int nDim>
void computeNormSqr(MultiGridTensorField2D<T,nDim>& tensorField, MultiGridScalarField2D<T>& component, Box2D domain)
{
    applyProcessingFunctional (
            new ComputeNormSqrFunctional2D<T,nDim>, domain, component, tensorField, tensorField.getReferenceLevel() );
}
...
{
    applyProcessingFunctional (
            new ComputeSymmetricTensorNormFunctional2D<T>, domain, norm, tensorField, tensorField.getReferenceLevel() );
}
...
domain)
{
    ...
    return std::auto_ptr<MultiGridScalarField2D<T> >(norm);
}
...
{
    applyProcessingFunctional (
            new ComputeSymmetricTensorNormSqrFunctional2D<T>, 
...
domain)
{
    ...
    return std::auto_ptr<MultiGridScalarField2D<T> >(normSqr);
}
...
{
    applyProcessingFunctional (
            new ComputeSymmetricTensorTraceFunctional2D<T>,
...
domain)
{
    ...
    return std::auto_ptr<MultiGridScalarField2D<T> >(trace);
}
...
void computeVorticity(MultiGridTensorField2D<T,2>& velocity, MultiGridScalarField2D<T>& vorticity, Box2D domain)
{
    plint envelopeWidth=1;
    applyProcessingFunctional (
            new BoxVorticityFunctional2D<T,2>, 
...
std::auto_ptr<MultiGridScalarField2D<T> > computeVorticity(MultiGridTensorField2D<T,2>& velocity, Box2D domain)
{
    ...
    return std::auto_ptr<MultiGridScalarField2D<T> >(vorticity);
}
...
void computeStrainRate(MultiGridTensorField2D<T,2>& velocity, MultiGridTensorField2D<T,3>& S, Box2D domain)
{
    plint envelopeWidth=1;
    applyProcessingFunctional (
            new BoxStrainRateFunctional2D<T,2>, 
...
std::auto_ptr<MultiGridTensorField2D<T,3> > computeStrainRate(MultiGridTensorField2D<T,2>& velocity, Box2D domain)
{
    ...
    return std::auto_ptr<MultiGridTensorField2D<T,3> >(S);
}
...
{
    applyProcessingFunctional (
            new CopyConvertTensorFunctional2D<T1,T2,nDim>, 
...
{
    MultiGridTensorField2D<T2,nDim>* convertedField = new MultiGridTensorField2D<T2,nDim>(field, domain);
    copyConvert<T1,T2,nDim>(field, *convertedField, domain);
    return std::auto_ptr<MultiGridTensorField2D<T2,nDim> >(convertedField);
}
...
Box2D domain)
{
    ...
    add(A, B, *result, domain);
    return std::auto_ptr<MultiGridTensorField2D<T,nDim> >(result);
}
...
void multiplyInPlace(MultiGridTensorField2D<T,nDim>& A, T alpha, Box2D domain) {
    applyProcessingFunctional (
            new Tensor_A_times_alpha_inplace_functional2D<T,nDim>(alpha), domain, A, A.getReferenceLevel());
}
...
void divideInPlace(MultiGridTensorField2D<T,nDim>& A, MultiGridTensorField2D<T,nDim>& B, Box2D domain) {
    applyProcessingFunctional (
            new Tensor_A_dividedBy_B_inplace_functional2D<T,nDim>, domain, A, B, A.getReferenceLevel() );
}
