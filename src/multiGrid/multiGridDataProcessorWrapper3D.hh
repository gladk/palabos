...
void applyProcessingFunctional(BoxProcessingFunctional3D_L<T,Descriptor>* functional,
                               Box3D domain, MultiGridLattice3D<T,Descriptor>& lattice, plint referenceLevel)
{
...
void integrateProcessingFunctional (
        ...
        Box3D domain, MultiGridLattice3D<T,Descriptor>& lattice, plint referenceLevel, plint level )
{
    addInternalProcessor( BoxProcessorGenerator3D(functional, domain), lattice, referenceLevel, level );
}
...
void applyProcessingFunctional(BoxProcessingFunctional3D_S<T>* functional,
                               Box3D domain, MultiGridScalarField3D<T>& field, plint referenceLevel)
{
...
void integrateProcessingFunctional(BoxProcessingFunctional3D_S<T>* functional,
                                   Box3D domain, MultiGridScalarField3D<T>& field, plint referenceLevel, plint level)
{
...
void applyProcessingFunctional(BoxProcessingFunctional3D_T<T,nDim>* functional,
                               Box3D domain, MultiGridTensorField3D<T,nDim>& field, plint referenceLevel)
{
    executeDataProcessor( BoxProcessorGenerator3D(functional, domain), field, referenceLevel );
}
...
void integrateProcessingFunctional(BoxProcessingFunctional3D_T<T,nDim>* functional,
                                   Box3D domain, MultiGridTensorField3D<T,nDim>& field, 
                                   plint referenceLevel, plint level)
{
    addInternalProcessor( BoxProcessorGenerator3D(functional, domain), field, referenceLevel, level );
}
...
void integrateProcessingFunctional(BoxProcessingFunctional3D_SS<T1,T2>* functional,
                                   Box3D domain,
                                   MultiGridScalarField3D<T1>& field1,
                                   MultiGridScalarField3D<T2>& field2, 
                                   plint referenceLevel, plint level)
{
    addInternalProcessor( BoxProcessorGenerator3D(functional, domain),
...
void integrateProcessingFunctional (
        ...
        Box3D domain,
        MultiGridTensorField3D<T1,nDim1>& field1,
        MultiGridTensorField3D<T2,nDim2>& field2,
        plint referenceLevel, plint level)
{
    addInternalProcessor( BoxProcessorGenerator3D(functional, domain),
                          field1, field2, referenceLevel, level );
...
void applyProcessingFunctional(BoxProcessingFunctional3D_ST<T1,T2,nDim>* functional,
                               Box3D domain,
                               MultiGridScalarField3D<T1>& field1,
                               MultiGridTensorField3D<T2,nDim>& field2, 
...
void integrateProcessingFunctional (
        ...
        Box3D domain,
        MultiGridLattice3D<T1,Descriptor>& lattice,
        MultiGridScalarField3D<T2>& field, plint referenceLevel, plint level )
{
    addInternalProcessor( BoxProcessorGenerator3D(functional, domain),
...
void integrateProcessingFunctional (
        ...
        Box3D domain,
        MultiGridLattice3D<T1,Descriptor>& lattice,
        MultiGridTensorField3D<T2,nDim>& field, 
        plint referenceLevel, plint level )
{
    addInternalProcessor( BoxProcessorGenerator3D(functional, domain),
                          lattice, field, referenceLevel, level );
...
void integrateProcessingFunctional (
        LatticeDotProcessingFunctional3D<T,Descriptor>* functional,
        DotList3D const& dotList,
        std::vector<MultiGridLattice3D<T,Descriptor>*> lattices, 
        plint referenceLevel, plint level )
{
    std::vector<MultiGrid3D*> multiBlocks(lattices.size());
    for (pluint iLattice=0; iLattice<lattices.size(); ++iLattice) {
...
void integrateProcessingFunctional(DotProcessingFunctional3D_L<T,Descriptor>* functional,
                                   ...
                                   plint referenceLevel, plint level)
{
    addInternalProcessor( DotProcessorGenerator3D(functional, dotList), lattice, referenceLevel, level );
}
...
void applyProcessingFunctional(DotProcessingFunctional3D_S<T>* functional,
                               DotList3D const& dotList, MultiGridScalarField3D<T>& field, plint referenceLevel)
{
...
void integrateProcessingFunctional(DotProcessingFunctional3D_S<T>* functional,
                                   DotList3D const& dotList, MultiGridScalarField3D<T>& field, 
                                   plint referenceLevel, plint level)
{
    addInternalProcessor( DotProcessorGenerator3D(functional, dotList), field, referenceLevel, level );
}
...
void integrateProcessingFunctional(DotProcessingFunctional3D_T<T,nDim>* functional,
                                   DotList3D const& dotList,
                                   MultiGridTensorField3D<T,nDim>& field,
                                   plint referenceLevel, plint level)
{
    addInternalProcessor( DotProcessorGenerator3D(functional, dotList), field, referenceLevel, level );
}
...
void integrateProcessingFunctional (
        ...
        DotList3D const& dotList,
        MultiGridLattice3D<T1,Descriptor1>& lattice1,
        MultiGridLattice3D<T2,Descriptor2>& lattice2, 
        plint referenceLevel, plint level )
{
    addInternalProcessor( DotProcessorGenerator3D(functional, dotList),
                          lattice1, lattice2, referenceLevel, level );
...
void integrateProcessingFunctional (
        ...
        DotList3D const& dotList,
        MultiGridLattice3D<T1,Descriptor>& lattice,
        MultiGridTensorField3D<T2,nDim>& field, plint referenceLevel, plint level)
{
    addInternalProcessor( DotProcessorGenerator3D(functional, dotList),
                          lattice, field, referenceLevel, level );
}
...
void applyProcessingFunctional (
        ...
        Box3D domain, MultiGridLattice3D<T,Descriptor>& lattice, plint referenceLevel, plint boundaryWidth )
{
...
void applyProcessingFunctional (
        ...
        Box3D domain, MultiGridScalarField3D<T>& field, plint referenceLevel, plint boundaryWidth )
{
    std::vector<MultiGrid3D*> multiBlocks(1);
...
void applyProcessingFunctional (
        ...
        Box3D domain, MultiGridTensorField3D<T,nDim>& field, plint referenceLevel, plint boundaryWidth )
{
    std::vector<MultiGrid3D*> multiBlocks(1);
    multiBlocks[0] = dynamic_cast<MultiGrid3D*>(&field);
    applyProcessingFunctional(functional, domain, multiBlocks, referenceLevel, boundaryWidth);
