...
template<typename T> class MultiGridScalarField3D;
template<typename T, int nDim> class MultiGridTensorField3D;
...
void applyProcessingFunctional(BoxProcessingFunctional3D_L<T,Descriptor>* functional,
                               Box3D domain, MultiGridLattice3D<T,Descriptor>& lattice,
...
void integrateProcessingFunctional(BoxProcessingFunctional3D_SS<T1,T2>* functional,
                                   Box3D domain,
                                   MultiGridScalarField3D<T1>& field1,
                                   MultiGridScalarField3D<T2>& field2, plint referenceLevel, plint level=0);
