...
template<typename T, template<typename U> class Descriptor>
void ScalarCubicInterpolationYZ<T,Descriptor>::process( Box3D coarseDomain,
...
template<typename T, template<typename U> class Descriptor>
ScalarCubicInterpolationYZLineY3D<T,Descriptor>::ScalarCubicInterpolationYZLineY3D(plint delta_,
...
template<typename T, template<typename U> class Descriptor>
void ScalarCubicInterpolationYZLineY3D<T,Descriptor>::process( Box3D coarseDomain,
                                            BlockLattice3D<T,Descriptor>& coarseLattice,
                                            BlockLattice3D<T,Descriptor>& fineLattice )
{
    Dot3D posCoarse = coarseLattice.getLocation();
...
template<typename T, template<typename U> class Descriptor>
ScalarCubicInterpolationYZLineY3D<T,Descriptor>* ScalarCubicInterpolationYZLineY3D<T,Descriptor>::clone() const
{
...
template<typename T, template<typename U> class Descriptor>
ScalarCubicInterpolationYZLineZ3D<T,Descriptor>::ScalarCubicInterpolationYZLineZ3D(plint delta_,
                                                                RescaleEngine<T,Descriptor>* rescaleEngine_)
        : delta(delta_), rescaleEngine(rescaleEngine_)
{}

template<typename T, template<typename U> class Descriptor>
void ScalarCubicInterpolationYZLineZ3D<T,Descriptor>::process( Box3D coarseDomain,
                                            BlockLattice3D<T,Descriptor>& coarseLattice,
                                            BlockLattice3D<T,Descriptor>& fineLattice  )
{
    Dot3D posCoarse = coarseLattice.getLocation();
...
template<typename T, template<typename U> class Descriptor>
ScalarCubicInterpolationYZLineZ3D<T,Descriptor>* ScalarCubicInterpolationYZLineZ3D<T,Descriptor>::clone() const
{
...
template<typename T, template<typename U> class Descriptor>
ScalarCubicInterpolationYZCorner3D<T,Descriptor>::ScalarCubicInterpolationYZCorner3D(plint deltaY_, plint deltaZ_,
                                                                        RescaleEngine<T,Descriptor>* rescaleEngine_)
...
template<typename T, template<typename U> class Descriptor>
ScalarCubicInterpolationYZCorner3D<T,Descriptor>* ScalarCubicInterpolationYZCorner3D<T,Descriptor>::clone() const
{
    return new ScalarCubicInterpolationYZCorner3D<T,Descriptor>(deltaY,deltaZ,rescaleEngine->clone() );
}

/* ************* ScalarCubicInterpolationXY ******************* */
template<typename T, template<typename U> class Descriptor>
void ScalarCubicInterpolationXY<T,Descriptor>::process( Box3D coarseDomain,
                          BlockLattice3D<T,Descriptor>& coarseLattice,
                          BlockLattice3D<T,Descriptor>& fineLattice )
{
    Dot3D posCoarse = coarseLattice.getLocation();
...
template<typename T, template<typename U> class Descriptor>
void ScalarCubicInterpolationXYLineX3D<T,Descriptor>::process( Box3D coarseDomain,
                                        BlockLattice3D<T,Descriptor>& coarseLattice,
                                        BlockLattice3D<T,Descriptor>& fineLattice )
{
    Dot3D posCoarse = coarseLattice.getLocation();
...
template<typename T, template<typename U> class Descriptor>
ScalarCubicInterpolationXYLineX3D<T,Descriptor>* ScalarCubicInterpolationXYLineX3D<T,Descriptor>::clone() const
{
...
template<typename T, template<typename U> class Descriptor>
void ScalarCubicInterpolationXYLineY3D<T,Descriptor>::process( Box3D coarseDomain,
                                        BlockLattice3D<T,Descriptor>& coarseLattice,
                                        BlockLattice3D<T,Descriptor>& fineLattice )
{
    Dot3D posCoarse = coarseLattice.getLocation();
...
template<typename T, template<typename U> class Descriptor>
ScalarCubicInterpolationXYLineY3D<T,Descriptor>* ScalarCubicInterpolationXYLineY3D<T,Descriptor>::clone() const
{
...
template<typename T, template<typename U> class Descriptor>
void ScalarCubicInterpolationXYCorner3D<T,Descriptor>::process( Box3D coarseDomain,
                                        BlockLattice3D<T,Descriptor>& coarseLattice,
                                        BlockLattice3D<T,Descriptor>& fineLattice )
{
    Dot3D posCoarse = coarseLattice.getLocation();
...
template<typename T, template<typename U> class Descriptor>
ScalarCubicInterpolationXYCorner3D<T,Descriptor>* ScalarCubicInterpolationXYCorner3D<T,Descriptor>::clone() const
{
    return new ScalarCubicInterpolationXYCorner3D<T,Descriptor>( deltaX, deltaY, rescaleEngine->clone() );
}


/* ************* ScalarCubicInterpolationXZ ******************* */
template<typename T, template<typename U> class Descriptor>
void ScalarCubicInterpolationXZ<T,Descriptor>::process( Box3D coarseDomain,
                          BlockLattice3D<T,Descriptor>& coarseLattice,
                          BlockLattice3D<T,Descriptor>& fineLattice )
{
    Dot3D posCoarse = coarseLattice.getLocation();
...
template<typename T, template<typename U> class Descriptor>
void ScalarCubicInterpolationXZLineX3D<T,Descriptor>::process( Box3D coarseDomain,
                                        BlockLattice3D<T,Descriptor>& coarseLattice,
                                        BlockLattice3D<T,Descriptor>& fineLattice )
{
    Dot3D posCoarse = coarseLattice.getLocation();
...
template<typename T, template<typename U> class Descriptor>
ScalarCubicInterpolationXZLineX3D<T,Descriptor>* ScalarCubicInterpolationXZLineX3D<T,Descriptor>::clone() const
{
...
template<typename T, template<typename U> class Descriptor>
void ScalarCubicInterpolationXZLineZ3D<T,Descriptor>::process( Box3D coarseDomain,
                                        BlockLattice3D<T,Descriptor>& coarseLattice,
                                        BlockLattice3D<T,Descriptor>& fineLattice )
{
    Dot3D posCoarse = coarseLattice.getLocation();
...
template<typename T, template<typename U> class Descriptor>
ScalarCubicInterpolationXZLineZ3D<T,Descriptor>* ScalarCubicInterpolationXZLineZ3D<T,Descriptor>::clone() const
{
...
template<typename T, template<typename U> class Descriptor>
void ScalarCubicInterpolationXZCorner3D<T,Descriptor>::process( Box3D coarseDomain,
                                        BlockLattice3D<T,Descriptor>& coarseLattice,
                                        BlockLattice3D<T,Descriptor>& fineLattice )
{
    Dot3D posCoarse = coarseLattice.getLocation();
...
template<typename T, template<typename U> class Descriptor>
ScalarCubicInterpolationXZCorner3D<T,Descriptor>* ScalarCubicInterpolationXZCorner3D<T,Descriptor>::clone() const
{
    return new ScalarCubicInterpolationXZCorner3D<T,Descriptor>( deltaX, deltaZ, rescaleEngine->clone() );
}
