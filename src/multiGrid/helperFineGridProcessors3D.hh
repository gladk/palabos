...
template<typename T, template<typename U> class Descriptor>
void CubicInterpolationYZLineYHelper3D<T,Descriptor>::process( Box3D coarseDomain,
...
template<typename T, template<typename U> class Descriptor>
CubicInterpolationYZLineYHelper3D<T,Descriptor>* CubicInterpolationYZLineYHelper3D<T,Descriptor>::clone() const
{
...
template<typename T, template<typename U> class Descriptor>
void CubicInterpolationYZLineZHelper3D<T,Descriptor>::process( Box3D coarseDomain,
                          BlockLattice3D<T,Descriptor>& coarseLattice,
                          BlockLattice3D<T,Descriptor>& fineLattice )
{
    Dot3D posCoarse = coarseLattice.getLocation();
...
template<typename T, template<typename U> class Descriptor>
CubicInterpolationYZLineZHelper3D<T,Descriptor>* CubicInterpolationYZLineZHelper3D<T,Descriptor>::clone() const
{
...
template<typename T, template<typename U> class Descriptor>
void CubicInterpolationYZCornerHelper3D<T,Descriptor>::process( Box3D coarseDomain,
                            BlockLattice3D<T,Descriptor>& coarseLattice,
                            BlockLattice3D<T,Descriptor>& fineLattice )
{
    Dot3D posCoarse = coarseLattice.getLocation();
...
template<typename T, template<typename U> class Descriptor>
CubicInterpolationYZCornerHelper3D<T,Descriptor>* CubicInterpolationYZCornerHelper3D<T,Descriptor>::clone() const
{
    return new CubicInterpolationYZCornerHelper3D<T,Descriptor>(deltaY,deltaZ,rescaleEngine->clone());
}
...
template<typename T, template<typename U> class Descriptor>
void CubicInterpolationXYLineXHelper3D<T,Descriptor>::process( Box3D coarseDomain,
                          BlockLattice3D<T,Descriptor>& coarseLattice,
                          BlockLattice3D<T,Descriptor>& fineLattice )
{
    Dot3D posCoarse = coarseLattice.getLocation();
...
template<typename T, template<typename U> class Descriptor>
CubicInterpolationXYLineXHelper3D<T,Descriptor>* CubicInterpolationXYLineXHelper3D<T,Descriptor>::clone() const
{
...
template<typename T, template<typename U> class Descriptor>
CubicInterpolationXYLineYHelper3D<T,Descriptor>::CubicInterpolationXYLineYHelper3D( plint delta_,
                                RescaleEngine<T,Descriptor>* rescaleEngine_ )
    : delta(delta_),rescaleEngine(rescaleEngine_)
{
    PLB_PRECONDITION(delta == 1 || delta == -1);
    points[0] = Array<T,2>(0.0,1.5);
...
template<typename T, template<typename U> class Descriptor>
void CubicInterpolationXYLineYHelper3D<T,Descriptor>::process( Box3D coarseDomain,
                          BlockLattice3D<T,Descriptor>& coarseLattice,
                          BlockLattice3D<T,Descriptor>& fineLattice )
{
    Dot3D posCoarse = coarseLattice.getLocation();
    ...
    for (plint iY=y0-1; iY<=y1; ++iY){
        ...
        for (plint iComp=0; iComp<cellDim; ++iComp){
            ...
            interpValues1[iComp] = interpolatedValues[0]; interpValues2[iComp] = interpolatedValues[1];
            interpValues3[iComp] = interpolatedValues[2]; interpValues4[iComp] = interpolatedValues[3];
        }
...
template<typename T, template<typename U> class Descriptor>
CubicInterpolationXYLineYHelper3D<T,Descriptor>* CubicInterpolationXYLineYHelper3D<T,Descriptor>::clone() const
{
...
template<typename T, template<typename U> class Descriptor>
CubicInterpolationXYCornerHelper3D<T,Descriptor>::CubicInterpolationXYCornerHelper3D(plint deltaX_, 
        plint deltaY_, RescaleEngine<T,Descriptor>* rescaleEngine_)
        : deltaX(deltaX_),deltaY(deltaY_),rescaleEngine(rescaleEngine_)
{}
    
template<typename T, template<typename U> class Descriptor>
void CubicInterpolationXYCornerHelper3D<T,Descriptor>::process( Box3D coarseDomain,
                          BlockLattice3D<T,Descriptor>& coarseLattice,
                          BlockLattice3D<T,Descriptor>& fineLattice
                          )
{
...
template<typename T, template<typename U> class Descriptor>
CubicInterpolationXYCornerHelper3D<T,Descriptor>* CubicInterpolationXYCornerHelper3D<T,Descriptor>::clone() const
{
    return new CubicInterpolationXYCornerHelper3D<T,Descriptor>(deltaX,deltaY,rescaleEngine->clone());
}
...
template<typename T, template<typename U> class Descriptor>
void CubicInterpolationXZLineXHelper3D<T,Descriptor>::process( Box3D coarseDomain,
                          BlockLattice3D<T,Descriptor>& coarseLattice,
                          BlockLattice3D<T,Descriptor>& fineLattice )
{
    Dot3D posCoarse = coarseLattice.getLocation();
...
template<typename T, template<typename U> class Descriptor>
CubicInterpolationXZLineXHelper3D<T,Descriptor>* CubicInterpolationXZLineXHelper3D<T,Descriptor>::clone() const
{
...
template<typename T, template<typename U> class Descriptor>
void CubicInterpolationXZLineZHelper3D<T,Descriptor>::process( Box3D coarseDomain,
                BlockLattice3D<T,Descriptor>& coarseLattice,
                BlockLattice3D<T,Descriptor>& fineLattice )
{
    Dot3D posCoarse = coarseLattice.getLocation();
...
template<typename T, template<typename U> class Descriptor>
CubicInterpolationXZLineZHelper3D<T,Descriptor>* CubicInterpolationXZLineZHelper3D<T,Descriptor>::clone() const
{
...
template<typename T, template<typename U> class Descriptor>
CubicInterpolationXZCornerHelper3D<T,Descriptor>::CubicInterpolationXZCornerHelper3D(plint deltaX_, 
                                                        plint deltaZ_, RescaleEngine<T,Descriptor>* rescaleEngine_)
        : deltaX(deltaX_),deltaZ(deltaZ_),rescaleEngine(rescaleEngine_)
{}
    
template<typename T, template<typename U> class Descriptor>
void CubicInterpolationXZCornerHelper3D<T,Descriptor>::process( Box3D coarseDomain,
                          BlockLattice3D<T,Descriptor>& coarseLattice,
                          BlockLattice3D<T,Descriptor>& fineLattice
                          )
{
...
template<typename T, template<typename U> class Descriptor>
CubicInterpolationXZCornerHelper3D<T,Descriptor>* CubicInterpolationXZCornerHelper3D<T,Descriptor>::clone() const
{
    return new CubicInterpolationXZCornerHelper3D<T,Descriptor>(deltaX,deltaZ,rescaleEngine->clone());
}
