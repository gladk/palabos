...
void applyProcessingFunctional(BoxProcessingFunctional2D_L<T,Descriptor>* functional,
                               Box2D domain, MultiGridLattice2D<T,Descriptor>& lattice, plint referenceLevel)
{
...
void integrateProcessingFunctional (
        ...
        Box2D domain, MultiGridLattice2D<T,Descriptor>& lattice, plint referenceLevel, plint level )
{
    addInternalProcessor( BoxProcessorGenerator2D(functional, domain), lattice, referenceLevel, level );
}
...
void applyProcessingFunctional(BoxProcessingFunctional2D_S<T>* functional,
                               Box2D domain, MultiGridScalarField2D<T>& field, plint referenceLevel)
{
...
void integrateProcessingFunctional(BoxProcessingFunctional2D_S<T>* functional,
                                   Box2D domain, MultiGridScalarField2D<T>& field, plint referenceLevel, plint level)
{
...
void applyProcessingFunctional(BoxProcessingFunctional2D_T<T,nDim>* functional,
                               Box2D domain, MultiGridTensorField2D<T,nDim>& field, plint referenceLevel)
{
    executeDataProcessor( BoxProcessorGenerator2D(functional, domain), field, referenceLevel );
}
...
void integrateProcessingFunctional(BoxProcessingFunctional2D_T<T,nDim>* functional,
                                   Box2D domain, MultiGridTensorField2D<T,nDim>& field, 
                                   plint referenceLevel, plint level)
{
    addInternalProcessor( BoxProcessorGenerator2D(functional, domain), field, referenceLevel, level );
}
        ...
        MultiGridLattice2D<T2,Descriptor2>& lattice2, plint referenceLevel )
{
    executeDataProcessor( BoxProcessorGenerator2D(functional, domain),
                          lattice1, lattice2, referenceLevel );
}
...
{
    addInternalProcessor( BoxProcessorGenerator2D(functional, domain),
                          lattice1, lattice2, referenceLevel, level );
}
...
void integrateProcessingFunctional(BoxProcessingFunctional2D_SS<T1,T2>* functional,
                                   Box2D domain,
                                   MultiGridScalarField2D<T1>& field1,
                                   MultiGridScalarField2D<T2>& field2, 
                                   plint referenceLevel, plint level)
{
    addInternalProcessor( BoxProcessorGenerator2D(functional, domain),
                          field1, field2, referenceLevel, level );
}
...
void integrateProcessingFunctional (
        ...
        Box2D domain,
        MultiGridTensorField2D<T1,nDim1>& field1,
        MultiGridTensorField2D<T2,nDim2>& field2,
        plint referenceLevel, plint level)
{
    addInternalProcessor( BoxProcessorGenerator2D(functional, domain),
                          field1, field2, referenceLevel, level );
...
void applyProcessingFunctional(BoxProcessingFunctional2D_ST<T1,T2,nDim>* functional,
                               Box2D domain,
                               MultiGridScalarField2D<T1>& field1,
                               MultiGridTensorField2D<T2,nDim>& field2, 
...
void integrateProcessingFunctional (
        ...
        Box2D domain,
        MultiGridLattice2D<T1,Descriptor>& lattice,
        MultiGridScalarField2D<T2>& field, plint referenceLevel, plint level )
{
    addInternalProcessor( BoxProcessorGenerator2D(functional, domain),
...
void integrateProcessingFunctional (
        LatticeDotProcessingFunctional2D<T,Descriptor>* functional,
        DotList2D const& dotList,
        std::vector<MultiGridLattice2D<T,Descriptor>*> lattices, 
        plint referenceLevel, plint level )
{
    std::vector<MultiGrid2D*> multiBlocks(lattices.size());
    for (pluint iLattice=0; iLattice<lattices.size(); ++iLattice) {
...
void integrateProcessingFunctional(DotProcessingFunctional2D_L<T,Descriptor>* functional,
                                   ...
                                   plint referenceLevel, plint level)
{
    addInternalProcessor( DotProcessorGenerator2D(functional, dotList), lattice, referenceLevel, level );
}
...
void applyProcessingFunctional(DotProcessingFunctional2D_S<T>* functional,
                               DotList2D const& dotList, MultiGridScalarField2D<T>& field, plint referenceLevel)
{
...
void integrateProcessingFunctional(DotProcessingFunctional2D_S<T>* functional,
                                   DotList2D const& dotList, MultiGridScalarField2D<T>& field, 
                                   plint referenceLevel, plint level)
{
    addInternalProcessor( DotProcessorGenerator2D(functional, dotList), field, referenceLevel, level );
}
...
void integrateProcessingFunctional(DotProcessingFunctional2D_T<T,nDim>* functional,
                                   DotList2D const& dotList,
                                   MultiGridTensorField2D<T,nDim>& field,
                                   plint referenceLevel, plint level)
{
    addInternalProcessor( DotProcessorGenerator2D(functional, dotList), field, referenceLevel, level );
}
...
void integrateProcessingFunctional (
        ...
        DotList2D const& dotList,
        MultiGridLattice2D<T1,Descriptor1>& lattice1,
        MultiGridLattice2D<T2,Descriptor2>& lattice2, 
        plint referenceLevel, plint level )
{
    addInternalProcessor( DotProcessorGenerator2D(functional, dotList),
                          lattice1, lattice2, referenceLevel, level );
...
void integrateProcessingFunctional (
        ...
        DotList2D const& dotList,
        MultiGridLattice2D<T1,Descriptor>& lattice,
        MultiGridTensorField2D<T2,nDim>& field, plint referenceLevel, plint level)
{
    addInternalProcessor( DotProcessorGenerator2D(functional, dotList),
                          lattice, field, referenceLevel, level );
}
        ...
        plint boundaryWidth, plint level )
{
    ...
    integrateProcessingFunctional(functional, domain, multiBlocks, referenceLevel,
                                  boundaryWidth, level);
}
        ...
        plint referenceLevel, plint boundaryWidth )
{
    ...
    applyProcessingFunctional(functional, domain,
                              multiBlocks, referenceLevel, boundaryWidth);
}
        ...
        plint boundaryWidth, plint level )
{
    ...
    integrateProcessingFunctional(functional, domain,
                                  multiBlocks, referenceLevel, boundaryWidth, level);
}
...
void applyProcessingFunctional (
        ...
        Box2D domain, MultiGridLattice2D<T,Descriptor>& lattice, plint referenceLevel, plint boundaryWidth )
{
...
void applyProcessingFunctional (
        ...
        Box2D domain, MultiGridScalarField2D<T>& field, plint referenceLevel, plint boundaryWidth )
{
    std::vector<MultiGrid2D*> multiBlocks(1);
...
void applyProcessingFunctional (
        ...
        Box2D domain, MultiGridTensorField2D<T,nDim>& field, plint referenceLevel, plint boundaryWidth )
{
    std::vector<MultiGrid2D*> multiBlocks(1);
    multiBlocks[0] = dynamic_cast<MultiGrid2D*>(&field);
    applyProcessingFunctional(functional, domain, multiBlocks, referenceLevel, boundaryWidth);
