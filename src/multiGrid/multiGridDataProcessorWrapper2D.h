...
template<typename T> class MultiGridScalarField2D;
template<typename T, int nDim> class MultiGridTensorField2D;
...
void applyProcessingFunctional(BoxProcessingFunctional2D_L<T,Descriptor>* functional,
                               Box2D domain, MultiGridLattice2D<T,Descriptor>& lattice,
...
void integrateProcessingFunctional(BoxProcessingFunctional2D_SS<T1,T2>* functional,
                                   Box2D domain,
                                   MultiGridScalarField2D<T1>& field1,
                                   MultiGridScalarField2D<T2>& field2, plint referenceLevel, plint level=0);
