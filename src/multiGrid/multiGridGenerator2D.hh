                                               ...
                                               
{
    ...
    Box2D reducedLowerFineGridBorder(reducedFineGridInterface.x0, reducedFineGridInterface.x0,
                                     reducedFineGridInterface.y0, reducedFineGridInterface.y0 );
    Box2D reducedUpperFineGridBorder(reducedFineGridInterface.x1, reducedFineGridInterface.x1,
                                     reducedFineGridInterface.y1, reducedFineGridInterface.y1 );
    
    integrateProcessingFunctional (
            new CopyCoarseToFineBoundaryHelper2D<T, Descriptor,Descriptor> (
                rescaleEngine->clone(), BCdirection, orientation, toRight ),
            reducedLowerFineGridBorder,
            coarseLattice, fineLattice, processorLevelCoarse );
            
    integrateProcessingFunctional (
            new CopyCoarseToFineBoundaryHelper2D<T, Descriptor,Descriptor> (
                rescaleEngine->clone(), BCdirection, orientation, toLeft ),
            reducedUpperFineGridBorder,
            coarseLattice, fineLattice, processorLevelCoarse );
