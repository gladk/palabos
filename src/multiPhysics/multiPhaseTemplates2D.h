...
static void shanChenInteraction( BlockLattice2D<T,Descriptor>& lattice,
...
static void computeRhoAndJ(BlockLattice2D<T,Descriptor>& lattice,
                           plint iX, plint iY)
{
    enum {
...
static void computeUstar(std::vector<BlockLattice2D<T,Descriptor>*> lattices,
                         plint iX, plint iY,
...
static void computeUphys(std::vector<BlockLattice2D<T,Descriptor>*> lattices,
                         plint iX, plint iY,
