                          ...
                          T& surfY_M1, T& surfY_P1, T& surfZ_M1, T& surfZ_P1 )
{
    surfX_M1 = f[1] + f[4] + f[5] + f[6] + f[7] +
               f[10] + f[11] + f[12] + f[13];
    surfX_P1 = f[14] + f[17] + f[18] + f[19] + f[20] +
               f[23] + f[24] + f[25] + f[26];

    surfY_M1 = f[2] + f[4] + f[8] + f[9] + f[10] +
               f[11] + f[18] + f[25] + f[26];
    surfY_P1 = f[5] + f[12] + f[13] + f[15] + f[17] +
               f[21] + f[22] + f[23] + f[24];

    surfZ_M1 = f[3] + f[6] + f[8] + f[10] + f[12] +
               f[20] + f[22] + f[24] + f[26];
    surfZ_P1 = f[7] + f[9] + f[11] + f[13] + f[16] +
               f[19] + f[21] + f[23] + f[25];
}
...
static T get_eBar(Array<T,Descriptor::q> const& f) {
    T eBar = (T)3 * ( f[10] + f[11] + f[12] + f[13] +
                      f[23] + f[24] + f[25] + f[26] )
             +
             (T)2 * (f[4] + f[5] + f[6] +
                     f[7] + f[8] + f[9] +
...
static void compute_PiNeq(Array<T,Descriptor::q> const& f, T rhoBar, Array<T,3> const& j, Array<T,6>& PiNeq, T invRho)
{
    ...
    PiNeq[S::xy] = f[4] - f[5] + f[10] + f[11] - f[12] - f[13]
                   + f[17] - f[18] + f[23] + f[24] - f[25] - f[26]
                   - invRho*j[0]*j[1];
    PiNeq[S::xz] = f[6] - f[7] + f[10] - f[11] + f[12] - f[13]
                   + f[19] - f[20] + f[23] - f[24] + f[25] - f[26]
                   - invRho*j[0]*j[2];
    PiNeq[S::yz] = f[8] - f[9] + f[10] - f[11] - f[12] + f[13]
...
static void compute_P(Array<T,Descriptor::q> const& f, T rhoBar, Array<T,3> const& j, Array<T,6>& P) {
    ...
    P[S::xy] = f[4] - f[5] + f[10] + f[11] - f[12] - f[13]
               + f[17] - f[18] + f[23] + f[24] - f[25] - f[26]
               - invRho*j[0]*j[1];
    P[S::xz] = f[6] - f[7] + f[10] - f[11] + f[12] - f[13]
               + f[19] - f[20] + f[23] - f[24] + f[25] - f[26]
               - invRho*j[0]*j[2];
    P[S::yz] = f[8] - f[9] + f[10] - f[11] - f[12] + f[13]
               + f[21] - f[22] + f[23] - f[24] - f[25] + f[26]
               -invRho*j[1]*j[2];
}
...
static void compute_PiNeq(Array<T,Descriptor::q> const& f, T rhoBar, Array<T,3> const& j, Array<T,6>& PiNeq, T invRho)
{
    ...
    PiNeq[S::xy] =   f[4] + f[5] - f[6]  - f[7]
                   + f[11] + f[12] - f[13] - f[14] - invRho*j[0]*j[1];
    PiNeq[S::xz] =   f[4] - f[5] + f[6]  - f[7]
                   + f[11] - f[12] + f[13] - f[14] - invRho*j[0]*j[2];
    PiNeq[S::yz] =   f[4] - f[5] - f[6]  + f[7]
                   + f[11] - f[12] - f[13] + f[14] - invRho*j[1]*j[2];
}
...
static void compute_P(Array<T,Descriptor::q> const& f, T rhoBar, Array<T,3> const& j, Array<T,6>& P) {
    ...
    P[S::xy] =   f[4] + f[5] - f[6]  - f[7]
               + f[11] + f[12] - f[13] - f[14] - invRho*j[0]*j[1];
    P[S::xz] =   f[4] - f[5] + f[6]  - f[7]
               + f[11] - f[12] + f[13] - f[14] - invRho*j[0]*j[2];
    P[S::yz] =   f[4] - f[5] - f[6]  + f[7]
               + f[11] - f[12] - f[13] + f[14] - invRho*j[1]*j[2];
}
