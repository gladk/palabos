...
BoxSumCustomForcedEnergyFunctional3D<T,Descriptor,ForceFunction>::BoxSumCustomForcedEnergyFunctional3D(ForceFunction f_)
    : f(f_),
      sumEnergyId(this->getStatistics().subscribeSum())
{ }
...
template<typename T, template<typename U> class Descriptor, class ForceFunction> 
void BoxSumCustomForcedEnergyFunctional3D<T,Descriptor,ForceFunction>::getDimensionsX(std::vector<int>& dimensions) const
{
    dimensions.resize(1);
    dimensions[0] = 2;
}
...
template<typename T, template<typename U> class Descriptor, class ForceFunction> 
void BoxSumCustomForcedEnergyFunctional3D<T,Descriptor,ForceFunction>::getDimensionsT(std::vector<int>& dimensions) const
{
    dimensions.resize(1);
    dimensions[0] = -2;
}
...
template<typename T, template<typename U> class Descriptor, class ForceFunction> 
BoxCustomForcedVelocityNormFunctional3D<T,Descriptor,ForceFunction>::BoxCustomForcedVelocityNormFunctional3D(ForceFunction f_)
    : f(f_)
{ }
...
template<typename T, template<typename U> class Descriptor, class ForceFunction> 
BlockDomain::DomainT BoxCustomForcedVelocityNormFunctional3D<T,Descriptor,ForceFunction>::appliesTo() const {
    return BlockDomain::bulk;
}
...
template<typename T, template<typename U> class Descriptor, class ForceFunction> 
BoxCustomForcedVelocityComponentFunctional3D<T,Descriptor,ForceFunction>::BoxCustomForcedVelocityComponentFunctional3D(
        ForceFunction f_, int iComponent_)
    : f(f_),
      iComponent(iComponent_)
{ }
...
template<typename T, template<typename U> class Descriptor, class ForceFunction> 
void BoxCustomForcedVelocityComponentFunctional3D<T,Descriptor,ForceFunction>::getTypeOfModification(
        std::vector<modif::ModifT>& modified) const {
    modified[0] = modif::nothing;
    modified[1] = modif::staticVariables;
}
...
template<typename T, template<typename U> class Descriptor, class ForceFunction> 
BlockDomain::DomainT BoxCustomForcedVelocityComponentFunctional3D<T,Descriptor,ForceFunction>::appliesTo() const {
    return BlockDomain::bulk;
}
...
template<typename T, template<typename U> class Descriptor, class ForceFunction> 
BoxCustomForcedVelocityFunctional3D<T,Descriptor,ForceFunction>::BoxCustomForcedVelocityFunctional3D(ForceFunction f_)
    : f(f_)
{ }
...
template<typename T, template<typename U> class Descriptor, class ForceFunction> 
BlockDomain::DomainT BoxCustomForcedVelocityFunctional3D<T,Descriptor,ForceFunction>::appliesTo() const
{
    return BlockDomain::bulk;
}
