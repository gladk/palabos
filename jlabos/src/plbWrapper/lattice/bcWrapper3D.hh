 ...
 */
#ifndef BC_WRAPPER_3D_HH
#define BC_WRAPPER_3D_HH
...
OuterBoxBC<T,Descriptor>::OuterBoxBC (
        OnLatticeBoundaryCondition3D<T,Descriptor>* bc_ )
    : bc(bc_)
{ }
...
OuterBoxBC<T,Descriptor>* generateRegularizedBC() {
    return new OuterBoxBC<T,Descriptor>(createLocalBoundaryCondition3D<T,Descriptor>());
}

}  // namespace plb

#endif  // BC_WRAPPER_3D_HH
