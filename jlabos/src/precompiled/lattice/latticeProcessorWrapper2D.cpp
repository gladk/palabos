...
void applyProcessingFunctional<FLOAT_T, descriptors::DESCRIPTOR_2D> (
        ...
        Box2D domain, BlockLattice2D<FLOAT_T,descriptors::DESCRIPTOR_2D>& lattice );
template
void integrateProcessingFunctional<FLOAT_T, descriptors::DESCRIPTOR_2D> (
        BoxProcessingFunctional2D_L<FLOAT_T, descriptors::DESCRIPTOR_2D>* functional,
        Box2D domain, BlockLattice2D<FLOAT_T, descriptors::DESCRIPTOR_2D>& lattice, plint level );
template
void applyProcessingFunctional<FLOAT_T, descriptors::DESCRIPTOR_2D,
        ...
        Box2D domain,
        BlockLattice2D<FLOAT_T,descriptors::DESCRIPTOR_2D>& lattice1,
        BlockLattice2D<FLOAT_T,descriptors::DESCRIPTOR_2D>& lattice2 );
template
void integrateProcessingFunctional<FLOAT_T, descriptors::DESCRIPTOR_2D,
                                   FLOAT_T, descriptors::DESCRIPTOR_2D> (
        BoxProcessingFunctional2D_LL<FLOAT_T, descriptors::DESCRIPTOR_2D,
        ...
        Box2D domain,
        BlockLattice2D<FLOAT_T, descriptors::DESCRIPTOR_2D>& lattice1,
        BlockLattice2D<FLOAT_T, descriptors::DESCRIPTOR_2D>& lattice2, plint level );
template
...
void integrateProcessingFunctional<FLOAT_T, descriptors::DESCRIPTOR_2D, FLOAT_T> (
        ...
        Box2D domain,
        BlockLattice2D<FLOAT_T, descriptors::DESCRIPTOR_2D>& lattice,
        NTensorField2D<FLOAT_T>& field, plint level );

template
void applyProcessingFunctional<FLOAT_T, descriptors::DESCRIPTOR_2D> (
        LatticeBoxProcessingFunctional2D<FLOAT_T,descriptors::DESCRIPTOR_2D>* functional,
        Box2D domain, std::vector<BlockLattice2D<FLOAT_T,descriptors::DESCRIPTOR_2D>*> lattices );
template
void integrateProcessingFunctional<FLOAT_T, descriptors::DESCRIPTOR_2D> (
        LatticeBoxProcessingFunctional2D<FLOAT_T, descriptors::DESCRIPTOR_2D>* functional,
        Box2D domain, std::vector<BlockLattice2D<FLOAT_T, descriptors::DESCRIPTOR_2D>*> lattices, plint level );
...
void applyProcessingFunctional<FLOAT_T, descriptors::DESCRIPTOR_2D> (
        ...
        Box2D domain, BlockLattice2D<FLOAT_T,descriptors::DESCRIPTOR_2D>& lattice, plint boundaryWidth );
template
void integrateProcessingFunctional<FLOAT_T, descriptors::DESCRIPTOR_2D> (
        BoundedBoxProcessingFunctional2D_L<FLOAT_T, descriptors::DESCRIPTOR_2D>* functional,
        Box2D domain, BlockLattice2D<FLOAT_T, descriptors::DESCRIPTOR_2D>& lattice, plint boundaryWidth, plint level );
